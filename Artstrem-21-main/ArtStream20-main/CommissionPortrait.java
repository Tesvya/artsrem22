...
public class CommissionPortrait extends JFrame implements ActionListener,ItemListener {
    ...
    public CommissionPortrait(String artistName) {
        ...
        if (isEmpty()) {
            ...
            int select = JOptionPane.showConfirmDialog(null,
             ...
             if (select == JOptionPane.YES_OPTION) {
                ...
                new Mytag(nameField.getText(), "Portrait", details);
